...
function NavBar({ currentUserManage }: any) {
  ...
  return (
    <div className="flex justify-between items-center p-4 border-b border-orange-200 bg-white shadow-sm print:hidden">
      ...
      <div className="flex-1 flex justify-center">
        <h1 className="text-xl font-bold text-orange-600">
          {parseCurrentUser?.instit?.name || "نظام إدارة المؤسسات الدينية"}
        </h1>
      </div>
      ...
      <div className="flex items-center space-x-4">
        ...
        {parseCurrentUser && (
          <Popover>
            <PopoverTrigger className="bg-orange-500 hover:bg-orange-600 text-white px-3 py-2 rounded-lg text-sm font-medium transition-colors duration-200">
              ...
              <div className="space-y-1">
                {parseCurrentUser?.role === "SUPERADMIN" && (
                  <>
                    <Button
                      asChild
                      className="w-full justify-start bg-transparent hover:bg-orange-50 text-gray-700 h-8"
                    >
